...
/**
 * Purpose: Multi-town asset-based procedural generation for VRBox v10.
 * Key features: Loads manifest from selected town folder.
 ...
 * Timestamp: 2025-06-22 12:00 | File: js/assetBasedTownBuilder.js
 */
...
// Change this to select your active town
const ACTIVE_TOWN = 'town1'; 

let manifest = null;

export async function generateTown() {
    console.log(`[VRBox] Loading manifest for ${ACTIVE_TOWN}...`);
    manifest = await loadManifest(ACTIVE_TOWN);
