...
/**
 * Purpose: Final fully stable manifest + scaling generator using glTF-Transform v4.x bounds() function.
 * Dependencies: @gltf-transform/core, @gltf-transform/functions
 * MIT License: https://github.com/[new-repo-path]/LICENSE
 * Timestamp: 2025-06-22 15:30 | File: AutoScalingManifestGenerator.js
 */
...
async function generateManifestAndScaling() {
    ...
    for (const folder of SUBFOLDERS) {
        ...
        for (const file of files) {
            ...
            try {
                const { min, max } = await bounds(document);
                ...
                console.warn(`[VRBox] WARNING: Failed to compute bounds for ${relPath}. Using default scale 1.0`);
            }
