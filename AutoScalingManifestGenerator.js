...
/**
 * Purpose: Fully safe manifest + scaling generator handling all missing, incomplete, or invalid accessor bounds.
 * Dependencies: @gltf-transform/core v4.x
 * Timestamp: 2025-06-22 15:10 | File: AutoScalingManifestGenerator.js
 */
        ...
        for (const file of files) {
            ...
            for (const accessor of accessors) {
                if (accessor.getType() === 'VEC3' && accessor.getArray().length > 0) {
                    ...
                    if (Array.isArray(accMin) && accMin.length === 3 &&
                        Array.isArray(accMax) && accMax.length === 3) {
