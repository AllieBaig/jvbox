...
/**
 * Purpose: Fully automated manifest + humanoid-relative scaling generator.
 * Key features: Reads scalingDefaults.json with humanoidHeight and expected category heights.
 * MIT License: https://github.com/[new-repo-path]/LICENSE
 * Timestamp: 2025-06-22 17:10 | File: AutoScalingManifestGenerator_HumanoidRelative.js
 */
...
async function generateManifestAndScaling() {
    ...
    for (const folder of SUBFOLDERS) {
        ...
        for (const file of files) {
            ...
            // Core scaling formula: normalize relative to humanoid
